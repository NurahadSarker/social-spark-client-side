...
const FeaturesSection = () => {
    return (
        <div>
            <div className='max-w-[400px] mx-auto sm:max-w-[400px] sm:mx-auto md:max-w-[1200px] md:mx-auto py-5 md:pt-20 md:pb-10'>
                <div className='flex flex-col items-center justify-center mb-5 md:mb-10'>
                    <h1 className='text-3xl md:text-5xl font-bold text-[#29B467] mb-2'>Our Features</h1>
                </div>
                {/*Features*/}
                <div>
                    <div className='md:flex items-center justify-center gap-10 mb-10'>
                        <div className='md:w-[500px] md:h-[280px]'>
