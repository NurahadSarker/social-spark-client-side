...
const AboutUsPage = () => {
  return (
    <div className="max-w-[1200px] mx-auto py-20">
      <h1 className="text-5xl font-bold text-center text-[#29B467] mb-10">
        About Us
      </h1>

      <div className="items-center">
        <div>
          <h2 className="text-3xl text-center font-semibold mb-4 text-[#29B467]">
      ...
      <div className="mt-16 text-center">
        <h3 className="text-2xl font-semibold mb-3 text-[#29B467]">
          Our Mission & Vision
        </h3>
